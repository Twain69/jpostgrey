...
public interface DataFetcher {
	...
	default public FetcherResult getResult(InputRecord inputRecord) throws InputRecordNotFoundException {
	...
	default public void addEntryToWhitelist(WhiteListEntry whiteListEntry) {
		System.out.println("Not supported (yet) with the datafetcher you configured");
	}
